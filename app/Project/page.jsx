...
const page = () => {
  const ProjectsData = [
    ...
    },
    {
      ...
      description:
        "An e-commerce website using React, Next.js, and Tailwind CSS.",
    },
    {
      image: "/chatgpt.jpg",
    ...
    },
    {
      ...
      description:
        "A portfolio website using Next.js, React.js, and Tailwind CSS.",
    },
  ];
  ...
  return (
    <div className="mt-20 text-white text-center">
      ...
      <p className="font-bold m-10">
        For See More Projects Visit My <Link href={"https://github.com/uncle-joshi?tab=repositories"} className="cursor-pointer text-indigo-500"> Github </Link>
      </p>
    </div>
  );
};
